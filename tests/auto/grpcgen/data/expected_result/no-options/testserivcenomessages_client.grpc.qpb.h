...
public:
    ...
    QGrpcStatus testMethod(const qtprotobufnamespace::tests::SimpleStringMessage &arg, qtprotobufnamespace::tests::SimpleStringMessage *ret, const QGrpcCallOptions &options = {});
