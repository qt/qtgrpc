...
QGrpcStatus Client::testMethod(const qtprotobufnamespace::tests::SimpleStringMessage &arg, qtprotobufnamespace::tests::SimpleStringMessage *ret, const QGrpcCallOptions &options)
{
    return call<qtprotobufnamespace::tests::SimpleStringMessage>("testMethod"_L1, arg, ret, options);
}
