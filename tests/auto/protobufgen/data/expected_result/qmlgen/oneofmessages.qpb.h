...
public:
    ...
    QPB_TST_QTPROTOBUFGEN_QML_GEN_EXPORT void setTestOneofFieldInt(const QtProtobuf::int32 &testOneofFieldInt);
    QPB_TST_QTPROTOBUFGEN_QML_GEN_EXPORT void setTestOneofFieldSecondInt(const QtProtobuf::int32 &testOneofFieldSecondInt);
...
public:
    ...
    QPB_TST_QTPROTOBUFGEN_QML_GEN_EXPORT void setSecondFieldInt(const QtProtobuf::int32 &secondFieldInt);
    ...
    QPB_TST_QTPROTOBUFGEN_QML_GEN_EXPORT void setTestSnakeCaseField(const QtProtobuf::int32 &testSnakeCaseField);
    Q_INVOKABLE QPB_TST_QTPROTOBUFGEN_QML_GEN_EXPORT void clearTestOneof();
